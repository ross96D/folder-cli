...
// 	var err error
// 	if t.pos.Focus {
// 		err = WriteString(t.Name, t.pos.line, t.pos.initial, termbox.ColorGreen)
// 	} else {
// 		err = WriteString(t.Name, t.pos.line, t.pos.initial, termbox.ColorDefault)
// 	}
// 	return err
// }
...
// 	if l.iFocus == 0 && !l.Items[0].pos.Focus {
